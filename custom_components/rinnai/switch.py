...
class RinnaiCommandSwitch(RinnaiEntity, SwitchEntity):
    ...
    Config keys:
        ...
        Q85 specific keys:
        command      – ENL parameter name (e.g. "temporaryCycleInsulationSetting")
        command_value – value to send on toggle (e.g. "31")
        on_state_check – dict with byte_index and on_value
    """
